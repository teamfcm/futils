...
namespace fender
{
    ...
    class Object : public futils::IEntity {
    ...
    // Old Code that should be deleted but can be useful for new version
    namespace {
//    class       Event
//    {
//    protected:
...
//    };
    ...
    public:
        ...
        virtual void loadSystems(futils::EntityManager &engine) = 0;
    };
